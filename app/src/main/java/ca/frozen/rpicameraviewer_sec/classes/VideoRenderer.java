package ca.frozen.rpicameraviewer_sec.classes;
...
import ca.frozen.rpicameraviewer_sec.activities.MainActivity;
import ca.frozen.rpicameraviewer_sec.activities.vr_VideoActivity;
...
*/
    ...
    vr_VideoActivity parentMainActivity;
    ...
    public VideoRenderer(vr_VideoActivity parentMainActivity)
    {
    ...
    public boolean setup()
    {
        ...
        try
        {
            AssetFileDescriptor afd = parentMainActivity.getAssets().openFd("makhna.mp4");
